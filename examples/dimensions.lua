...
#
### net ###
${goto 495}${color1}Down$color${alignr 180}${downspeed eth0}
${goto 495}${color1}Total$color${alignr 180}${totaldown eth0}
${voffset 29}#
${goto 495}${color1}Up$color${alignr 180}${upspeed eth0}
${goto 495}${color1}Total$color${alignr 180}${totalup eth0}
${voffset -88}#
#
### drives ###
${template5 root /}#
