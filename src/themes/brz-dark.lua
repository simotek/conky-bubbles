...
local theme = {
    ...
    header_font = {color=header_color,font_family="SUSE", font_size=header_font_size, border_width=0.8, border_color=temperature_colors[2]},
    
    --- Font used in block widget for status text
    -- A table of args that can be passed to Static or Conky text
    status_font = {color=temperature_colors[3],font_family="SUSE Mono", font_size=header_font_size, border_width=0.3, border_color=temperature_colors[2]},
    ...
    dimensionsrc_asset_path = "assets/brz-dark/"
}
